...
public class ModelTest {
    ...
    void destroyBaseTest() {
        ...
        GameObjects gameObjects = new GameObjects(
                ...
                new ArrayList<>(),
                new ArrayList<>());
        LevelObject levelObject = new LevelObject(gameObjects, new ArrayList<>(), 832, 832, 15, 15, 1, 1, 1);
    ...
    void enemySpawnOnEnemyTest() {
        ...
        LevelObject levelObject = new LevelObject(gameObjects,
                new ArrayList<>() {{
                    add(new EnemySpawnObject(360, 645));
                }},
                832, 832, 15, 15, 1, 1, 10);
        BattleField field = new BattleField(levelObject);
        TestFieldListener listener = new TestFieldListener();
    ...
    void killEnemyTest() {
        ...
        LevelObject levelObject = new LevelObject(gameObjects, new ArrayList<>(), 832, 832, 15, 15, 1, 1, 10);
        BattleField field = new BattleField(levelObject);
        TestFieldListener listener = new TestFieldListener();
        field.setFieldListener(listener);
        assertEquals(1, field.toGameObjects().enemies().size());
    ...
    void winByKillingEveryoneTest() {
        ...
        LevelObject levelObject = new LevelObject(gameObjects, new ArrayList<>(), 832, 832, 15, 15, 1, 1, 0);
        BattleField field = new BattleField(levelObject);
        TestFieldListener listener = new TestFieldListener();
        field.setFieldListener(listener);
        field.shootTank();
